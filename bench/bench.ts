...
summary(() => {
  group("simple — 3 strings", () => {
    bench("classigo v2 (optimized) ", () =>
      classigoV2("btn", "btn--primary", "btn--lg"),
    );
    bench("classigo v2 (before)    ", () =>
      classigoV2before("btn", "btn--primary", "btn--lg"),
    );
    bench("classigo v1 (npm 1.0.1) ", () =>
      classigoV1npm("btn", "btn--primary", "btn--lg"),
    );
    bench("classigo v1 (inline)    ", () =>
      classigoV1inline("btn", "btn--primary", "btn--lg"),
    );
    bench("classigo lite           ", () =>
      classigoLite("btn", "btn--primary", "btn--lg"),
    );
    bench("clsx                    ", () =>
      clsx("btn", "btn--primary", "btn--lg"),
    );
    bench("classnames              ", () =>
  ...
  group("re-render — boolean toggles each call", () => {
    ...
    bench("classigo v1 (npm 1.0.1) ", () => {
      ...
      return classigoV1npm(
        "btn",
        tick ? "btn--active" : undefined,
        isDisabled && "btn--disabled",
      );
    });
    bench("classigo v1 (inline)    ", () => {
      tick ^= 1;
      return classigoV1inline(
        "btn",
        tick ? "btn--active" : undefined,
        isDisabled && "btn--disabled",
      );
  ...
  group("ultra-dynamic — all args vary per call", () => {
    bench("classigo v2 (optimized) ", () => {
      ...
      return classigoV2(
        "badge",
        `badge--${s}`,
        s === "loading" && "badge--pulse",
        s === "error" && "badge--shake",
        {
          "badge--visible": s !== "idle",
          "badge--highlighted": s === "success",
        },
      );
    });
    bench("classigo v2 (before)    ", () => {
...
const v1Size = sz(
  resolve(__dirname, "../node_modules/classigo-v1/dist/index.mjs"),
);
...
console.log(
  `classigo lite ${liteSize ? kb(liteSize).padStart(9) : "build first"}`,
);
